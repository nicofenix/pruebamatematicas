...
document.getElementById("player_question").innerHTML = "turno para responer - " + player2_name; 
}else{ 
    question_turn = "player1";
...
if(answer_turn == "player1"){
    ...
    document.getElementById("player_answer").innerHTML = "turno para responder - " + player2_name; 
        ...
        question_turn = "player1";
    document.getElementById("player_answer").innerHTML = "turno para rensponder - " + player1_name; 
    }
